  ...
  return (
    <Layout style={{ minHeight: '100vh' }}>
      ...
      <Content>
        ...
        <div style={{ 
          ...
          <Paragraph style={{ 
            ...
            キャラクターシートの可視化から情報共有まで、
            TRPGセッションに必要なツールを一箇所で
          </Paragraph>
          <Link to="/systems">
            <Button 
              type="primary" 
          ...
          <Row gutter={[32, 32]} justify="center">
            ...
            <Col xs={24} md={8}>
              <Card 
                ...
                bodyStyle={{ padding: '40px 24px' }}
              >
                <TeamOutlined style={{ fontSize: '48px', color: '#52c41a', marginBottom: '20px' }} />
                <Title level={4}>セッション管理</Title>
                <Paragraph>
                  TRPGセッションの情報を共有し、
                  プレイヤー間のコミュニケーションをサポート
                </Paragraph>
              </Card>
            </Col>
            ...
            <Col xs={24} md={8}>
              <Card 
                ...
                bodyStyle={{ padding: '40px 24px' }}
              >
                <UserOutlined style={{ fontSize: '48px', color: '#722ed1', marginBottom: '20px' }} />
      ...
      <Footer style={{ textAlign: 'center', background: '#f0f2f5' }}>
        <Divider />
        <Text type="secondary">
          TRPG Web Tools ©2024 - TRPGをもっと楽しく
        </Text>
      </Footer>
    </Layout>
  );
